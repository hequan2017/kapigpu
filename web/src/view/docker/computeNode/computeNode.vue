...
<template>
  ...
  <el-select v-model="searchInfo.clusterId" filterable placeholder="请选择集群" :clearable="true">
  ...
  <el-select v-model="searchInfo.isOnline" clearable placeholder="请选择">
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="docker_ComputeNode" />
            <ExportExcel  template-id="docker_ComputeNode" filterDeleted/>
            <ImportExcel  template-id="docker_ComputeNode" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="集群" prop="clusterId" width="120">
    <template #default="scope">
        <span>{{ filterDataSource(dataSource.clusterId,scope.row.clusterId) }}</span>
    </template>
</el-table-column>
            ...
            <el-table-column align="left" label="Docker连接地址" prop="dockerAddr" width="120" />

            <el-table-column align="left" label="是否上架" prop="isOnline" width="120">
    <template #default="scope">{{ formatBoolean(scope.row.isOnline) }}</template>
</el-table-column>
    ...
    <template #default="scope">
        <span>{{ filterDataSource(dataSource.clusterId,detailForm.clusterId) }}</span>
    </template>
</el-descriptions-item>
...
const onSubmit = () => {
  elSearchFormRef.value?.validate(async(valid) => {
    if (!valid) return
    page.value = 1
    if (searchInfo.value.isOnline === ""){
        searchInfo.value.isOnline=null
    }
    getTableData()
  })
}
